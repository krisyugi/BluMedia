  ...
  return (
    <div className="fixed bottom-5 right-5 z-50">
      ...
      <div className="flex items-center gap-2">
        <button
          onClick={() => setOpen((o) => !o)}
          aria-label={t({ en: "Send us a message", fr: "Envoyez-nous un message" })}
          title={t({ en: "Send us a message", fr: "Envoyez-nous un message" })}
          className="sm:hidden inline-flex items-center gap-2 rounded-full bg-primary px-3 py-2 text-xs text-primary-foreground shadow-lg transition hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-ring"
        >
          ...
          <span>{t({ en: "Send us a message", fr: "Envoyez-nous un message" })}</span>
        </button>
        <button
          onClick={() => setOpen((o) => !o)}
